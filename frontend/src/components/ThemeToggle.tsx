  ...
  return (
    <>
      <label className="themeSwitcherThree relative inline-flex cursor-pointer select-none items-center">
        ...
        <div className="shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-md bg-gray-200 dark:bg-gray-600">
          <span
            className={`flex h-9 w-9 items-center justify-center rounded ${
              !isChecked
                ? "bg-primary text-white"
                : "bg-white dark:bg-gray-800 text-lightBlue-500"
            }`}
            style={{
              border: isChecked ? "2px solid #FFFFFF" : "2px solid #D1D5DB",
